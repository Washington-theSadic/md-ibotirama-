...
export const Hero = () => {
  ...
  return <section id="hero" className="relative min-h-[90vh] flex items-center justify-center px-4 py-16 md:py-24 bg-cover bg-center" style={{
    ...
    backgroundPosition: "center center"
      ...
      <div className="container mx-auto relative z-10 text-center">
        ...
        <p className="text-lg md:text-xl text-white mb-8 max-w-2xl mx-auto transform translate-y-0 opacity-100 transition-all duration-700 delay-500">O Mais Delivery já transformou negócios em mais de 300 cidades — o próximo pode ser o seu.</p>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {['+ 300 cidades em todo o Brasil', '+ Milhares de clientes potenciais', '+ Eficiência no atendimento e gestão', '+ Vendas com novo canal de pedidos'].map((item, index) => <li key={index} className="bg-white/10 backdrop-blur-sm text-white py-3 px-4 rounded-lg font-medium transform transition-all duration-500" style={{
